...
Мы используем обобщённый тип и типовые переменные. Выполнив выше указанные условия программа выведет:
0
99
default
hello
то есть если мы предоставим программе null, то выведется альтернатива, иначе само значение. В программе используется два типа переменных Integer и String.То есть если мы вводим переменную Integer, то альтернатива тоже должна быть такого типа.
...
Так же в программе есть проверка на ввод.
...
В данной задачи я использую уже созданные классы Point2D и Point3D.
Пример:
